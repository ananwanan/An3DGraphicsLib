...
namespace anan3d
{
  ...
  public:
     ...
     * @return the translation matrix, which is a 4x4 matrix, and the translation is performed around the origin, which is the point (0, 0, 0), and the translation is
     * performed in the right-hand rule, which means that if the axis is pointing towards you, the translation is counter-clockwise, and if the axis is pointing
     * away from you, the translation is clockwise
     */
